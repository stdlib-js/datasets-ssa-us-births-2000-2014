...
```javascript
dataset = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/datasets-ssa-us-births-2000-2014@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/datasets-ssa-us-births-2000-2014@umd/bundle.js"></script>
```
