...
```javascript
dataset = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/datasets-ssa-us-births-2000-2014@v0.2.3-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/datasets-ssa-us-births-2000-2014@v0.2.3-umd/browser.js"></script>
```
